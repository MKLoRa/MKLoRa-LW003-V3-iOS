...
@implementation MKBVTextButtonCellModel
@end

@interface MKBVTextButtonCell ()
...
@implementation MKBVTextButtonCell

+ (MKBVTextButtonCell *)initCellWithTableView:(UITableView *)tableView {
    MKBVTextButtonCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKBVTextButtonCellIdenty"];
    if (!cell) {
        cell = [[MKBVTextButtonCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKBVTextButtonCellIdenty"];
    }
    return cell;
}
...
- (void)rightButtonPressed {
    if ([self.delegate respondsToSelector:@selector(bv_textButtonCell_buttonAction:)]) {
        [self.delegate bv_textButtonCell_buttonAction:self.dataModel.index];
    }
}

#pragma mark - setter
- (void)setDataModel:(MKBVTextButtonCellModel *)dataModel {
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKBVTextButtonCellModel.class]) {
        return;
    }
