...
@implementation MKBVLoRaSettingConfigModel
...
@interface MKBVLoRaSettingModel ()

@property (nonatomic, strong)dispatch_queue_t readQueue;

@property (nonatomic, strong)dispatch_semaphore_t semaphore;

@property (nonatomic, strong)MKBVLoRaSettingConfigModel *configModel;

@end

@implementation MKBVLoRaSettingModel
...
- (BOOL)configModem {
    __block BOOL success = NO;
    [MKBVInterface bv_configModem:(self.modem - 1) sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readDevEUI {
    __block BOOL success = NO;
    [MKBVInterface bv_readLorawanDEVEUIWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configDevEUI {
    __block BOOL success = NO;
    [MKBVInterface bv_configDEVEUI:self.devEUI sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readAppEUI {
    __block BOOL success = NO;
    [MKBVInterface bv_readLorawanAPPEUIWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configAppEUI {
    __block BOOL success = NO;
    [MKBVInterface bv_configAPPEUI:self.appEUI sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readAppKey {
    __block BOOL success = NO;
    [MKBVInterface bv_readLorawanAPPKEYWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configAppKey {
    __block BOOL success = NO;
    [MKBVInterface bv_configAPPKEY:self.appKey sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readDevAddr {
    __block BOOL success = NO;
    [MKBVInterface bv_readLorawanDEVADDRWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configDevAddr {
    __block BOOL success = NO;
    [MKBVInterface bv_configDEVADDR:self.devAddr sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readAppSkey {
    __block BOOL success = NO;
    [MKBVInterface bv_readLorawanAPPSKEYWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configAppSkey {
    __block BOOL success = NO;
    [MKBVInterface bv_configAPPSKEY:self.appSKey sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readNwkSkey {
    __block BOOL success = NO;
    [MKBVInterface bv_readLorawanNWKSKEYWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configNwkSkey {
    __block BOOL success = NO;
    [MKBVInterface bv_configNWKSKEY:self.nwkSKey sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readCHValue {
    __block BOOL success = NO;
    [MKBVInterface bv_readLorawanCHWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configCHValue {
    __block BOOL success = NO;
    [MKBVInterface bv_configCHL:self.CHL CHH:self.CHH sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readDutyStatus {
    __block BOOL success = NO;
    [MKBVInterface bv_readLorawanDutyCycleStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configDutyStatus {
    __block BOOL success = NO;
    [MKBVInterface bv_configDutyCycleStatus:self.dutyIsOn sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readJoinValue {
    __block BOOL success = NO;
    [MKBVInterface bv_readLorawanDRWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configJoinValue {
    __block BOOL success = NO;
    [MKBVInterface bv_configDR:self.join sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readUplinkStrategy {
    __block BOOL success = NO;
    [MKBVInterface bv_readLorawanUplinkStrategyWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configUplinkStrategy {
    __block BOOL success = NO;
    [MKBVInterface bv_configUplinkStrategy:self.adrIsOn transmissions:(self.transmissions + 1) DRL:self.DRL DRH:self.DRH sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readACKLimit {
    __block BOOL success = NO;
    [MKBVInterface bv_readLorawanADRACKLimitWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configACKLimit {
    __block BOOL success = NO;
    [MKBVInterface bv_configLorawanADRACKLimit:[self.ackLimit integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readACKDelay {
    __block BOOL success = NO;
    [MKBVInterface bv_readLorawanADRACKDelayWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configACKDelay {
    __block BOOL success = NO;
    [MKBVInterface bv_configLorawanADRACKDelay:[self.ackDelay integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)restartDevice {
    __block BOOL success = NO;
    [MKBVInterface bv_restartDeviceWithSucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (MKBVLoRaSettingConfigModel *)configModel {
    if (!_configModel) {
        _configModel = [[MKBVLoRaSettingConfigModel alloc] init];
    }
    return _configModel;
}
