...
@interface MKBVLoRaSettingConfigModel : NSObject
...
@interface MKBVLoRaSettingModel : NSObject

@property (nonatomic, strong, readonly)MKBVLoRaSettingConfigModel *configModel;
