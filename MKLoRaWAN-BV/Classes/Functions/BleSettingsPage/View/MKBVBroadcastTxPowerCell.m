...
@implementation MKBVBroadcastTxPowerCellModel
@end

@interface MKBVBroadcastTxPowerCell ()
...
@implementation MKBVBroadcastTxPowerCell

+ (MKBVBroadcastTxPowerCell *)initCellWithTableView:(UITableView *)tableView {
    MKBVBroadcastTxPowerCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKBVBroadcastTxPowerCellIdenty"];
    if (!cell) {
        cell = [[MKBVBroadcastTxPowerCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKBVBroadcastTxPowerCellIdenty"];
    }
    return cell;
}
...
- (void)txPowerSliderValueChanged {
    ...
    if ([self.delegate respondsToSelector:@selector(bv_txPowerValueChanged:)]) {
        [self.delegate bv_txPowerValueChanged:(NSInteger)self.slider.value];
    }
}
...
#pragma mark - setter
- (void)setDataModel:(MKBVBroadcastTxPowerCellModel *)dataModel {
    _dataModel = nil;
