...
@implementation MKBVSelftestCellModel
@end

@interface MKBVSelftestCell ()
...
@implementation MKBVSelftestCell

+ (MKBVSelftestCell *)initCellWithTableView:(UITableView *)tableView {
    MKBVSelftestCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKBVSelftestCellIdenty"];
    if (!cell) {
        cell = [[MKBVSelftestCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKBVSelftestCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKBVSelftestCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKBVSelftestCellModel.class]) {
        return;
    }
