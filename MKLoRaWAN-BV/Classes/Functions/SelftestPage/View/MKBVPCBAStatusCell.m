...
@implementation MKBVPCBAStatusCellModel
@end

@interface MKBVPCBAStatusCell ()
...
@implementation MKBVPCBAStatusCell

+ (MKBVPCBAStatusCell *)initCellWithTableView:(UITableView *)tableView {
    MKBVPCBAStatusCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKBVPCBAStatusCellIdenty"];
    if (!cell) {
        cell = [[MKBVPCBAStatusCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKBVPCBAStatusCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKBVPCBAStatusCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKBVPCBAStatusCellModel.class]) {
        return;
    }
