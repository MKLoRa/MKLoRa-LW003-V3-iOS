...
@implementation MKBVSelftestModel
...
- (BOOL)readPCBAStatus {
    ...
    [MKBVInterface bv_readPCBAStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readSelftestStatus {
    __block BOOL success = NO;
    [MKBVInterface bv_readSelftestStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
