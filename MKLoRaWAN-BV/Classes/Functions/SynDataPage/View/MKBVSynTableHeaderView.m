...
@implementation MKBVMsgIconButton
...
@interface MKBVSynTableHeaderView ()
...
@property (nonatomic, strong)MKBVMsgIconButton *synButton;

@property (nonatomic, strong)MKBVMsgIconButton *emptyButton;

@property (nonatomic, strong)MKBVMsgIconButton *exportButton;
...
@implementation MKBVSynTableHeaderView
...
- (MKBVMsgIconButton *)synButton {
    if (!_synButton) {
        _synButton = [[MKBVMsgIconButton alloc] init];
        _synButton.topIcon.image = LOADICON(@"MKLoRaWAN-BV", @"MKBVSynTableHeaderView", @"bv_sync_enableIcon.png");
        _synButton.msgLabel.text = @"Sync";
    }
    return _synButton;
}

- (MKBVMsgIconButton *)emptyButton {
    if (!_emptyButton) {
        _emptyButton = [[MKBVMsgIconButton alloc] init];
        _emptyButton.topIcon.image = LOADICON(@"MKLoRaWAN-BV", @"MKBVSynTableHeaderView", @"bv_delete_enableIcon.png");
        _emptyButton.msgLabel.text = @"Empty";
    }
    return _emptyButton;
}

- (MKBVMsgIconButton *)exportButton {
    if (!_exportButton) {
        _exportButton = [[MKBVMsgIconButton alloc] init];
        _exportButton.topIcon.image = LOADICON(@"MKLoRaWAN-BV", @"MKBVSynTableHeaderView", @"bv_export_enableIcon.png");
