...
@interface MKBVUpdateController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKBVDFUModule *dfuModule;
...
@implementation MKBVUpdateController

- (void)dealloc {
    NSLog(@"MKBVUpdateController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_bv_startDfuProcessNotification" object:nil];
...
- (void)updateComplete {
    ...
    [MKBVCentralManager sharedDealloc];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_bv_centralDeallocNotification" object:nil];
...
- (MKBVDFUModule *)dfuModule {
    if (!_dfuModule) {
        _dfuModule = [[MKBVDFUModule alloc] init];
    }
    return _dfuModule;
}
