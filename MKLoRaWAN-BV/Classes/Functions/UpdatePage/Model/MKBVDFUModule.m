...
@interface MKBVDFUModule()<LoggerDelegate, DFUServiceDelegate, DFUProgressDelegate>
...
@implementation MKBVDFUModule

- (void)dealloc{
    NSLog(@"MKBVDFUModule销毁");
}
...
- (void)updateWithFileUrl:(NSString *)url
    ...
    self.dfuController = [initiator startWithTarget:[MKBVCentralManager shared].peripheral];
}
