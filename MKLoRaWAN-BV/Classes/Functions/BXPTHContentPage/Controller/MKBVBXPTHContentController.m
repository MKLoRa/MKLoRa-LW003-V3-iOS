...
@interface MKBVBXPTHContentController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKBVBXPTHContentModel *dataModel;

@end

@implementation MKBVBXPTHContentController

- (void)dealloc {
    NSLog(@"MKBVBXPTHContentController销毁");
}
...
- (void)loadSection1Datas {
    ...
    cellModel6.isOn = self.dataModel.battery;
...
#pragma mark - UI
- (void)loadSubViews {
    self.defaultTitle = @"BXP-T&H Content";
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-BV", @"MKBVBXPTHContentController", @"bv_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKBVBXPTHContentModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKBVBXPTHContentModel alloc] init];
    }
    return _dataModel;
}
