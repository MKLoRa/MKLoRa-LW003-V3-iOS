//
//  MKBVFilterByBXPTagController.m
...
@interface MKBVFilterByBXPTagController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKBVFilterByBXPTagModel *dataModel;

@end

@implementation MKBVFilterByBXPTagController

- (void)dealloc {
    NSLog(@"MKBVFilterByBXPTagController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-BV", @"MKBVFilterByBXPTagController", @"bv_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKBVFilterByBXPTagModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKBVFilterByBXPTagModel alloc] init];
    }
    return _dataModel;
}
