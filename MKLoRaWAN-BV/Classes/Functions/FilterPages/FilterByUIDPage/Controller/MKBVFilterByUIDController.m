...
@interface MKBVFilterByUIDController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKBVFilterByUIDModel *dataModel;

@end

@implementation MKBVFilterByUIDController

- (void)dealloc {
    NSLog(@"MKBVFilterByUIDController销毁");
}
...
- (void)mk_bv_filterNormalTextFieldValueChanged:(NSString *)text index:(NSInteger)index {
    ...
    if (index == 1) {
        ...
        MKBVFilterNormalTextFieldCellModel *cellModel = self.section1List[1];
        cellModel.textFieldValue = text;
        return;
    }
}
...
- (void)loadSection1Datas {
    MKBVFilterNormalTextFieldCellModel *cellModel1 = [[MKBVFilterNormalTextFieldCellModel alloc] init];
    cellModel1.index = 0;
    ...
    MKBVFilterNormalTextFieldCellModel *cellModel2 = [[MKBVFilterNormalTextFieldCellModel alloc] init];
    cellModel2.index = 1;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-BV", @"MKBVFilterByUIDController", @"bv_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKBVFilterByUIDModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKBVFilterByUIDModel alloc] init];
    }
    return _dataModel;
}
