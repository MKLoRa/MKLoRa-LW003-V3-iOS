//
//  MKBVFilterByBXPButtonController.m
...
@interface MKBVFilterByBXPButtonController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKBVFilterByBXPButtonModel *dataModel;

@property (nonatomic, strong)NSMutableArray *headerList;

@end

@implementation MKBVFilterByBXPButtonController

- (void)dealloc {
    NSLog(@"MKBVFilterByBXPButtonController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-BV", @"MKBVFilterByBXPButtonController", @"bv_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKBVFilterByBXPButtonModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKBVFilterByBXPButtonModel alloc] init];
    }
    return _dataModel;
}
