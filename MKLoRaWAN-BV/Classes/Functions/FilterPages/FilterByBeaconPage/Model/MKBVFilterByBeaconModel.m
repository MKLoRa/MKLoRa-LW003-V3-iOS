...
@interface MKBVFilterByBeaconModel ()
...
@implementation MKBVFilterByBeaconModel
...
- (void)readDataWithSucBlock:(void (^)(void))sucBlock failedBlock:(void (^)(NSError *error))failedBlock {
    ...
    if (self.pageType == mk_bv_filterByBeaconPageType_bxpBeacon) {
...
- (BOOL)readBeaconFilterStatus {
    ...
    [MKBVInterface bv_readFilterByBeaconStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configBeaconFilterStatus {
    __block BOOL success = NO;
    [MKBVInterface bv_configFilterByBeaconStatus:self.isOn sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBeaconFilterMajor {
    __block BOOL success = NO;
    [MKBVInterface bv_readFilterByBeaconMajorRangeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configBeaconFilterMajor {
    ...
    [MKBVInterface bv_configFilterByBeaconMajor:isOn minValue:min maxValue:max sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBeaconFilterMinor {
    __block BOOL success = NO;
    [MKBVInterface bv_readFilterByBeaconMinorRangeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
        BOOL isOn = [returnData[@"result"][@"isOn"] boolValue];
        if (isOn) {
...
- (BOOL)configBeaconFilterMinor {
    ...
    [MKBVInterface bv_configFilterByBeaconMinor:isOn minValue:min maxValue:max sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBeaconFilterUUID {
    __block BOOL success = NO;
    [MKBVInterface bv_readFilterByBeaconUUIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configBeaconFilterUUID {
    __block BOOL success = NO;
    [MKBVInterface bv_configFilterByBeaconUUID:self.uuid sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBXPBeaconFilterStatus {
    __block BOOL success = NO;
    [MKBVInterface bv_readFilterByBXPBeaconStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
        self.isOn = [returnData[@"result"][@"isOn"] boolValue];
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
...
- (BOOL)configBXPBeaconFilterStatus {
    __block BOOL success = NO;
    [MKBVInterface bv_configFilterByBXPBeaconStatus:self.isOn sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBXPBeaconFilterMajor {
    __block BOOL success = NO;
    [MKBVInterface bv_readFilterByBXPBeaconMajorRangeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
        BOOL isOn = [returnData[@"result"][@"isOn"] boolValue];
        if (isOn) {
            self.minMajor = returnData[@"result"][@"minValue"];
...
- (BOOL)configBXPBeaconFilterMajor {
    ...
    [MKBVInterface bv_configFilterByBXPBeaconMajor:isOn minValue:min maxValue:max sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBXPBeaconFilterMinor {
    __block BOOL success = NO;
    [MKBVInterface bv_readFilterByBXPBeaconMinorRangeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
        BOOL isOn = [returnData[@"result"][@"isOn"] boolValue];
        if (isOn) {
            self.minMinor = returnData[@"result"][@"minValue"];
...
- (BOOL)configBXPBeaconFilterMinor {
    ...
    [MKBVInterface bv_configFilterByBXPBeaconMinor:isOn minValue:min maxValue:max sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBXPBeaconFilterUUID {
    __block BOOL success = NO;
    [MKBVInterface bv_readFilterByBXPBeaconUUIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
        self.uuid = returnData[@"result"][@"uuid"];
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
...
- (BOOL)configBXPBeaconFilterUUID {
    __block BOOL success = NO;
    [MKBVInterface bv_configFilterByBXPBeaconUUID:self.uuid sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
