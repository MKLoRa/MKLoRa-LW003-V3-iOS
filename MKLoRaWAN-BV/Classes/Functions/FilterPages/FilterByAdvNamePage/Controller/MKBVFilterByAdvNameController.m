//
//  MKBVFilterByAdvNameController.m
...
@interface MKBVFilterByAdvNameController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKBVFilterByAdvNameModel *dataModel;

@end

@implementation MKBVFilterByAdvNameController

- (void)dealloc {
    NSLog(@"MKBVFilterByAdvNameController销毁");
}
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    if (section == 1) {
        MKBVFilterEditSectionHeaderViewModel *headerModel = [[MKBVFilterEditSectionHeaderViewModel alloc] init];
        headerModel.index = 0;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-BV", @"MKBVFilterByAdvNameController", @"bv_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKBVFilterByAdvNameModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKBVFilterByAdvNameModel alloc] init];
    }
    return _dataModel;
}
