...
@interface MKBVFilterByURLController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKBVFilterByURLModel *dataModel;

@end

@implementation MKBVFilterByURLController

- (void)dealloc {
    NSLog(@"MKBVFilterByURLController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-BV", @"MKBVFilterByURLController", @"bv_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKBVFilterByURLModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKBVFilterByURLModel alloc] init];
    }
    return _dataModel;
}
