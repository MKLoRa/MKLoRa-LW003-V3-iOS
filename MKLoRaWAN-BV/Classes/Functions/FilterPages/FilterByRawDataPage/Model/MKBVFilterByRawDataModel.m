...
@interface MKBVFilterByRawDataModel ()
...
@implementation MKBVFilterByRawDataModel
...
- (BOOL)readFilterByRawDataStatus {
    ...
    [MKBVInterface bv_readFilterTypeStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
