...
@implementation MKBVFilterRawAdvDataModel
...
@interface MKBVFilterByOtherModel ()
...
@implementation MKBVFilterByOtherModel
...
- (void)configWithRawDataList:(NSArray <MKBVFilterRawAdvDataModel *>*)list
                 relationship:(mk_bv_filterByOther)relationship
...
- (BOOL)readFilterStatus {
    ...
    [MKBVInterface bv_readFilterByOtherStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configFilterStatus {
    __block BOOL success = NO;
    [MKBVInterface bv_configFilterByOtherStatus:self.isOn sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readRelationship {
    __block BOOL success = NO;
    [MKBVInterface bv_readFilterByOtherRelationshipWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configRelationship:(NSInteger)relationship {
    __block BOOL success = NO;
    [MKBVInterface bv_configFilterByOtherRelationship:relationship sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readConditions {
    __block BOOL success = NO;
    [MKBVInterface bv_readFilterByOtherConditionsWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configConditions:(NSArray <MKBVFilterRawAdvDataModel *>*)list {
    __block BOOL success = NO;
    [MKBVInterface bv_configFilterByOtherConditions:list sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
