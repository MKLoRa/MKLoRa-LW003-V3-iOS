...
@implementation MKBVCreateLoRaDeviceModel
...
@interface MKBVNetworkService ()

@property (nonatomic, strong)NSURLSessionDataTask *addLoRaDeviceTask;

@end

@implementation MKBVNetworkService

+ (instancetype)share {
    static dispatch_once_t t;
    static MKBVNetworkService *service = nil;
    dispatch_once(&t, ^{
        service = [[MKBVNetworkService alloc] init];
    });
    return service;
}

- (void)addLoRaDeviceToCloud:(MKBVCreateLoRaDeviceModel *)deviceModel
