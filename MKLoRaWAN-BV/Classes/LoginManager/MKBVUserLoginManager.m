...
static MKBVUserLoginManager *loginManager = nil;
static dispatch_once_t onceToken;

@interface MKBVUserLoginManager ()
...
+ (MKBVUserLoginManager *)shared {
    dispatch_once(&onceToken, ^{
        if (!loginManager) {
            loginManager = [MKBVUserLoginManager new];
        }
    });
    return loginManager;
}
